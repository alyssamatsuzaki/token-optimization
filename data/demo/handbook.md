# Northwind Ridge Outfitters support handbook


## Overview {#sec-overview}

Northwind Ridge Outfitters has sold backcountry equipment since 2011. This handbook is policy version
2026.3, effective 2026-07-01, and it is the only document support
...
Questions arrive by email at help@northwindridge.example and through the storefront chat. Every answer
...
| --- | --- | --- | --- | --- | --- |
| Standard | $0.00 | 0 days | $75.00 | charged | no |
| Summit | $49.00 | 14 days | $40.00 | charged | no |
| Alpine | $129.00 | 30 days | $0.00 | waived | yes |
...
## Return windows by category {#sec-returns-windows}
...
| --- | --- | --- | --- |
| Tents and shelters | `tents` | 45 days | no |
| Sleeping bags | `sleeping_bags` | 45 days | no |
| Backpacks | `backpacks` | 60 days | no |
| Hiking footwear | `footwear` | 30 days | no |
| Insulated outerwear | `outerwear` | 45 days | no |
| Climbing hardware | `climbing_hardware` | 30 days | no |
| Climbing rope | `climbing_rope` | 14 days | no |
| Navigation electronics | `electronics` | 30 days | no |
| Camp stoves and cookware | `stoves` | 45 days | no |
| Water filters | `water_filters` | 30 days | no |
| Avalanche safety gear | `avalanche_safety` | 30 days | no |
| Trail nutrition | `nutrition` | 14 days | yes |
| Clearance apparel | `clearance_apparel` | 0 days | yes |
...
## Category notes {#sec-category-notes}
...
**Tents and shelters.** Poles and stakes must all be present. A tent pitched once is still returnable; a tent with ground-in dirt or a repaired panel is not.

**Sleeping bags.** Bags must be returned uncompressed. A bag stored compressed for months loses loft, and that loss is not a defect.

**Backpacks.** The longest window in the catalogue and no restocking fee, because fit is hard to judge indoors. Load the pack before deciding, and keep the hip belt clean.

**Hiking footwear.** Fit problems are the most common reason for return. Encourage customers to walk indoors first: worn outdoors, the refund becomes store credit.

**Insulated outerwear.** Insulation migration is a defect; a jacket that is simply warmer or colder than the customer expected is not.

**Climbing hardware.** Inspect for anodising scratches and rope grooves. Any hardware showing load marks is treated as used and is refused.

**Climbing rope.** The shortest window in the catalogue and the highest restocking fee. A rope uncoiled but never loaded may be returned; a rope climbed on may not.

**Navigation electronics.** Check the seal before quoting anything. An intact seal follows the category rule; a broken one follows the exception in section sec-exceptions.

**Camp stoves and cookware.** Fuel canisters are never returnable and never shipped. A stove run once for a test burn is returnable if it is clean.

**Water filters.** A filter that has passed water cannot be returned for hygiene reasons unless the housing itself is cracked, which is a defect.

**Avalanche safety gear.** Treat every claim as potentially safety-related. A transceiver that failed in the field goes to the customer relations manager, not the front line.

**Trail nutrition.** Final sale. Consumables cannot be restocked, and there is no warranty to claim against.

**Clearance apparel.** Final sale with a zero-day window. Customers often assume the loyalty bonus rescues this; it does not.

## Restocking fees {#sec-restocking}
...
| --- | --- |
| Tents and shelters | 10% |
| Sleeping bags | 10% |
| Backpacks | 0% |
| Hiking footwear | 0% |
| Insulated outerwear | 0% |
| Climbing hardware | 15% |
| Climbing rope | 20% |
| Navigation electronics | 15% |
| Camp stoves and cookware | 10% |
| Water filters | 10% |
| Avalanche safety gear | 0% |
| Trail nutrition | 0% |
| Clearance apparel | 0% |
...
| --- | --- | --- |
| Tents and shelters | 3 years | manufacturing defects in fabric, poles and seams |
| Sleeping bags | 5 years | loft loss, zipper failure and stitching defects |
| Backpacks | 10 years | seams, buckles, zippers and frame welds |
| Hiking footwear | 1 years | delamination and sole separation |
| Insulated outerwear | 3 years | seam sealing, zippers and insulation migration |
| Climbing hardware | 3 years | manufacturing defects only, never wear from use |
| Climbing rope | 1 years | manufacturing defects in the sheath or core |
| Navigation electronics | 2 years | battery failure and screen defects |
| Camp stoves and cookware | 2 years | valve and regulator defects |
| Water filters | 2 years | cartridge housing cracks and pump seal failure |
| Avalanche safety gear | 5 years | transceiver electronics and probe segment failure |
| Trail nutrition | 0 years | nothing; consumable goods carry no warranty |
| Clearance apparel | 0 years | nothing; clearance apparel is sold as is |
...
## Shipping zones {#sec-shipping-zones}

| Zone | Key | Transit time |
| --- | --- | --- |
| Zone 1 (in-state) | `zone_1` | 2 business days |
| Zone 2 (adjacent states) | `zone_2` | 3 business days |
| Zone 3 (continental) | `zone_3` | 5 business days |
| Zone 4 (Alaska and Hawaii) | `zone_4` | 8 business days |
| Zone 5 (international) | `zone_5` | 14 business days |
...
## Shipping fees {#sec-shipping-fees}
...
| Zone | up to 2 lb | over 2 lb up to 5 lb | over 5 lb up to 12 lb | over 12 lb up to 25 lb | over 25 lb up to 50 lb | over 50 lb |
| --- | --- | --- | --- | --- | --- | --- |
| Zone 1 (in-state) | $5.95 | $7.95 | $11.95 | $17.95 | $26.95 | $42.95 |
| Zone 2 (adjacent states) | $7.95 | $9.95 | $14.95 | $22.95 | $33.95 | $54.95 |
| Zone 3 (continental) | $9.95 | $13.95 | $19.95 | $29.95 | $44.95 | $71.95 |
| Zone 4 (Alaska and Hawaii) | $18.95 | $26.95 | $38.95 | $57.95 | $86.95 | $139.95 |
| Zone 5 (international) | $32.95 | $46.95 | $68.95 | $102.95 | $154.95 | $249.95 |

An oversize surcharge of $24.00 is added when the order weighs more
than 25 lb and contains an item from Tents and shelters, Backpacks. The surcharge is
...
which case Northwind Ridge Outfitters pays it.

## Free shipping thresholds {#sec-free-shipping}
...
**final-sale** — applies to Trail nutrition, Clearance apparel.

Final-sale items cannot be returned or exchanged for any reason other than a manufacturing defect reported within 7 days of delivery.

**opened-electronics** — applies to Navigation electronics.

Navigation electronics whose factory seal has been broken carry a return window of 14 days rather than the category's 30, and the restocking fee rises to 25 percent.

**used-climbing-safety** — applies to Climbing rope, Avalanche safety gear.

Climbing rope and avalanche safety gear that have been used in the field cannot be returned at all, because their condition cannot be verified.

**worn-footwear** — applies to Hiking footwear.

Hiking footwear worn outdoors may still be returned within the window, but only for store credit, never to the original payment method.

An exception never widens a window; it only narrows one or changes how the refund is paid.

## Seasonal return extension {#sec-seasonal}

**Holiday return extension** (holiday-extension). Orders placed between 2026-11-01 and
2026-12-24 inclusive receive 30 additional days on top of the
window the customer would otherwise have had.

The extension does not apply to Trail nutrition, Clearance apparel, Climbing rope. It stacks with the loyalty tier bonus: a Summit
member buying a backpack inside the holiday window gets the base window, plus the tier bonus,
plus the extension.

## Escalation {#sec-escalation}

| Level | Key | Handles | Resolution target |
| --- | --- | --- | --- |
| Front-line support | `tier_1` | standard returns, shipping questions, order status | 24 hours |
| Returns specialist | `tier_2` | disputed restocking fees, warranty assessments, exception requests | 48 hours |
| Customer relations manager | `tier_3` | refunds above the manager threshold, safety-related complaints, legal notices | 72 hours |

A refund above $500.00 goes to the customer relations manager regardless of how
...
96 hours escalates automatically to the next
level.

## Original packaging {#sec-packaging}

These categories must come back in their original packaging for a return to be accepted:
Tents and shelters, Sleeping bags, Hiking footwear, Climbing hardware, Climbing rope, Navigation electronics, Camp stoves and cookware, Water filters, Avalanche safety gear, Trail nutrition.

These do not: Backpacks, Insulated outerwear, Clearance apparel.
...
## Authorising a return {#sec-procedure}
...
7. **Work out the refund.** Item price minus the restocking fee, rounded to the nearest cent.
   ...
   Northwind Ridge Outfitters pays it.
