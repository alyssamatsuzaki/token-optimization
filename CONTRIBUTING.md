...
- Lead with the information a reader needs to act. Put background and rationale afterward.
- Prefer concrete subjects and verbs: “the runner stores failed calls,” not “failures are kept
  visible.”
- Use headings to help readers navigate, not to turn every paragraph into a separate section.
- Remove sales language, rhetorical questions, staged suspense, and claims that a choice is
  “obvious,” “honest,” or “the important part.” Explain the behavior and its consequence instead.
- Avoid repeated contrast formulas such as “not X, but Y” and “rather than.” State the rule once.
- Use bold text for labels and warnings, not general emphasis.
- Keep code comments close to the constraint they explain. Do not narrate the code line by line.
- Preserve the voice and factual record of historical logs. Improve navigation around them instead
  of rewriting past decisions.
